...
import {
  getAllItems as getProductos,
  getItemsByCategory,
} from "../../services/FireStore.js";
import { Container, Breadcrumb } from "react-bootstrap";
import { Link } from "react-router-dom";

function ItemListContainer({ greeting, item }) {
  ...
  function setCatPath() {
    if (category) {
      return (
        <Container className="d-flex text-center justify-content-center mb-10 pb-10 align-items-center p-5">
  ...
  return (
    <section id="menu" className="text-center container slide-in-fwd-center">
      <Container className="d-flex text-center justify-content-center mb-10 pb-10 align-items-center">
        <Breadcrumb>{setCatPath()}</Breadcrumb>
      </Container>
      <div className="album">
        <div className="container">
